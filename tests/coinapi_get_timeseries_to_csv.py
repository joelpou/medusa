...
url = 'https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_BTC_USD/history?period_id=15MIN&time_start=2012-01-01T00:00:00&time_end=2021-01-01T00:00:00&limit=100000'
...
df.to_csv(os.path.join(output_path, "coinapi_histdata_btc_usd_15MIN_2012-2021.csv"), index=False, header=True)